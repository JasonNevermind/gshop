<template>
  <div>
    <div class="shopcart">
      <div class="content" @click="isShow=!isShow">
        <div class="content-left">
          <div class="logo-wrapper">
            <div class="logo highlight">
              <i class="iconfont icon-shopping_cart highlight"></i>
            </div>
            <div class="num">{{shopCart.length}}</div>
          </div>
          <div class="price highlight">￥{{totalPrice}}</div>
          <div class="desc">另需配送费￥{{info.deliveryPrice}} 元</div>
        </div>
        <div class="content-right">
          <div class="pay not-enough" v-if="totalPrice<info.minPrice">还差￥{{info.minPrice-totalPrice}} 元起送</div>
      ...
      <div class="shopcart-list" v-if="isShow">
            ...
            <div class="list-content" @click.stop="">
                <ul>
                    <li class="food" v-for="(food,index) of shopCart" :key="index">
    ...
    <div class="list-mask" v-if="isShow" @click.stop=""></div>
  </div>
</template>
    ...
    computed:{
        ...
        totalPrice(){
            ...
            for(let i=0;i<this.shopCart.length;i++){
                totalprice+=this.shopCart[i].price*this.shopCart[i].count
            }
            return totalprice
        }
    },
